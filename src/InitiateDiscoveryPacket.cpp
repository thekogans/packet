...
namespace thekogans {
    namespace packet {
        ...
        THEKOGANS_UTIL_IMPLEMENT_SERIALIZABLE (InitiateDiscoveryPacket, 1)

        void InitiateDiscoveryPacket::Read (
                const BinHeader & /*header*/,
                util::Serializer &serializer) {
            serializer >> hostId;
        }

        void InitiateDiscoveryPacket::Write (util::Serializer &serializer) const {
            serializer << hostId;
        }
        ...
        void InitiateDiscoveryPacket::Write (pugi::xml_node &node) const {
        ...
        void InitiateDiscoveryPacket::Write (util::JSON::Object &object) const {
